...
const companies = [
  ...
  { name: "Carrier Global", sector: "Buildings", desc: "Leading global provider of HVAC, refrigeration, fire, and security solutions.", stats: { revenue: "$22.1B", employees: "52,000", hq: "Palm Beach Gardens, FL" } },
  { name: "Trane Technologies", sector: "Buildings", desc: "Climate innovator bringing efficient and sustainable solutions to buildings, homes, and transportation.", stats: { revenue: "$18.8B", employees: "40,000", hq: "Swords, Ireland" } },
