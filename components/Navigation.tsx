    ...
    <>
      ...
      >
        ...
        <div className="nav-hamburger">
          ...
          >
            <span style={{ display: "block", width: "22px", height: "2px", background: t.text, borderRadius: "1px", transition: "all 0.3s", transform: mobileOpen ? "translateY(3.5px) rotate(45deg)" : "none" }} />
            <span style={{ display: mobileOpen ? "none" : "block", width: "22px", height: "2px", background: t.text, borderRadius: "1px", transition: "all 0.3s" }} />
            <span style={{ display: "block", width: "22px", height: "2px", background: t.text, borderRadius: "1px", transition: "all 0.3s", transform: mobileOpen ? "translateY(-3.5px) rotate(-45deg)" : "none" }} />
          </button>
        </div>
      </nav>
