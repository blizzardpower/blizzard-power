...
const articles = [
  ...
  { title: "Heat Pump Adoption Rates Are Slowing — Here's the Data", sector: "Buildings", date: "Feb 14, 2026", read: "6 min", excerpt: "After two years of rapid growth, AHRI shipment data shows the heat pump installation boom may be plateauing. A closer look at the regional and economic drivers." },
        ...
        {articles.map((a, i) => (
          <div key={i} style={{ padding: "24px 0", borderBottom: `1px solid ${t.border}`, cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
              ...
              <span style={{ fontSize: "12px", color: t.textDim }}>&middot;</span>
